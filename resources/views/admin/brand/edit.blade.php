...
@section('title')Brandt @endsection
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.brand.update', $brand->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <img width="450px;" src="{{ asset($brand->logo) }}" alt="brand-image" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $brand->name) }}" class="form-control" id="type" placeholder="Type of the Product." />
                            </div>

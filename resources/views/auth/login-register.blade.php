                            ...
                            <div class="wsus__login">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="wsus__login_input">
                                        ...
                                        <input type="email" name="email" id="email" value="{{ old('email') }}" placeholder="example@email.com" required autofocus />
                                    </div>
                                    <div class="wsus__login_input">
                                    ...
                                    <div class="wsus__login_save">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="remember_me"
                                                id="remember_me flexSwitchCheckDefault">
                                            <label class="form-check-label" for="remember_me flexSwitchCheckDefault">Remember
                                                me</label>
                                        </div>
                            ...
                            <div class="wsus__login">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="wsus__login_input">
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="jhondoe@gmail.com">
                                    </div>
                                    <div class="wsus__login_input">
                                        <i class="fas fa-key"></i>
                                    ...
                                    <div class="wsus__login_save">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="tc" type="checkbox"
